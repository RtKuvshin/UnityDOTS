...
partial struct MeleeAttackSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach ((RefRO<LocalTransform> localTransform, 
                     ...
                     RefRO<Target> target, RefRW<UnitMover> unitMover) in SystemAPI.Query<RefRO<LocalTransform>, 
                     RefRW<MeleeAttack>, 
                     RefRO<Target>, RefRW<UnitMover>>().WithDisabled<MoveOverride>())
        {
            ...
            if (!isCloseEnoughToAttack)
            {
                ...
                float distanceExtraRaycast = 0.4f;
                RaycastInput raycastInput = new RaycastInput
                {
                    Start = localTransform.ValueRO.Position,
                    End = localTransform.ValueRO.Position + directionToTarget * (meleeAttack.ValueRO.colliderSize + distanceExtraRaycast),
